    ...
    class AppMenu extends HTMLElement {
      connectedCallback() {
        ...
        <a href="index.html" class="shrink h-16 flex items-center justify-center border-b border-dashed border-gray-200">
          ...
          <p class="text-lg font-medium">Reback - Django</p>
          </div>
        </a>
        <div class="grow">
        ...
        <div class="shrink text-center px-2 py-10">
          <span class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-md text-xs font-medium bg-blue-500 text-white">v1.1.0</span>
        </div>
      </div>`
      }
    }
    ...
    class AppFooter extends HTMLElement {
      connectedCallback() {
        ...
        <div class="flex md:justify-between justify-center w-full gap-4">
          <div>
            ${new Date().getFullYear()} © Reback - Django - <a href="#" target="_blank">Techzaa</a>
          </div>
          <div class="md:flex hidden gap-4 item-center md:justify-end">
            <a href="#" class="text-sm leading-5 text-zinc-600 transition hover:text-zinc-900" target="_blank">About</a>
            <span class="border-e border-gray-300 "></span>
            <a href="#" class="text-sm leading-5 text-zinc-600 transition hover:text-zinc-900" target="_blank">Support</a>
            <span class="border-e border-gray-300 "></span>
            <a href="#" class="text-sm leading-5 text-zinc-600 transition hover:text-zinc-900" target="_blank">Contact Us</a>
          </div>
        </div>
      </footer>`
      }
