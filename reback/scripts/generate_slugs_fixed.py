"""
Script CORREGIDO para generar slugs SIN ACENTOS.

Ejecutar: python generate_slugs_fixed.py
"""
import duckdb
import re
import unicodedata
...
def slugify(text):
    """Convertir texto a slug SEO-friendly SIN acentos."""
...
# Generar slugs
print("Generando slugs SIN ACENTOS...")
slugs_data = []
slug_counts = {}
