...
DJANGO_APPS = [
    ...
    # "django.contrib.sites",  # Not needed: allauth uses RequestSite when this is absent
...
MIGRATION_MODULES = {}  # sites removed — django.contrib.sites not in INSTALLED_APPS
...
# Must be False so JavaScript can read the CSRF token for AJAX POST requests.
...
# Google already verifies emails — skip redundant verification for social signups
SOCIALACCOUNT_EMAIL_VERIFICATION = "none"

# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "reback.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "reback.users.forms.UserSignupForm"}
# Redirect URLs for allauth
ACCOUNT_EMAIL_CONFIRMATION_AUTHENTICATED_REDIRECT_URL = "/dashboard-icfes/"
ACCOUNT_SIGNUP_REDIRECT_URL = "/dashboard-icfes/"
